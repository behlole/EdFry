                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($login_logs as $log)
                                <tr>
                                    ...
                                    <td data-label="@lang('Username')"><a href="{{ route('admin.user.detail', $log->user_id)}}"> {{ ($log->user) ? $log->user->username : '' }}</a></td>
                                    <td data-label="@lang('IP')">
                                        <a href="{{route('admin.user.login.ipHistory',[$log->user_ip])}}">
                                            {{ $log->user_ip }}
                                        </a>
                                    </td>
...
@push('breadcrumb-plugins')
    @if(request()->routeIs('admin.user.login.history'))
    <form action="{{ route('admin.user.login.history') }}" method="GET" class="form-inline float-sm-right bg--white">
