                    ...
                    <div class="booking-item d-flex flex-wrap align-items-center justify-content-between mb-5">
                        <div class="booking-left d-flex align-items-center">
                            <div class="booking-thumb">
                                <img
                                    src="{{getImage(imagePath()['doctor']['path'].'/'.$doctor->image,imagePath()['doctor']['size'])}}"
                                    alt="@lang('doctor')">
                        ...
                        <div class="booking-right">
                            <div class="booking-content">
                                <ul class="booking-list">
                                    ...
                                    <li><span><i
                                                class="fas fa-wallet"></i>@lang('Fees') :  {{ __($doctor->fees) }} {{__($general->cur_sym)}}<span>
                                    </li>
                                </ul>
                                <ul class="booking-tag">
                                    @foreach ($doctor->socialIcons as $item)
                                        <li><a href="{{ $item->url }}" target="_blank">@php echo $item->icon @endphp</a>
                                        </li>
                                    @endforeach
                                </ul>
                                <div class="booking-btn">
                            ...
                            <div class="tab-cont">
                                            ...
                                            <div class="overview-footer-area d-flex flex-wrap justify-content-between">
                                                <ul class="overview-footer-list">
                                                    @if($doctor->speciality != null || !empty($doctor->speciality))
                                                        @foreach ($doctor->speciality as $item)
                                                            <li>
                                                                <i class="fas fa-long-arrow-alt-right"></i>{{ __($item) }}
                                                            </li>
                                                        @endforeach
                                                    @endif
                                                </ul>
                                ...
                                <div class="tab-item">
                                    <div class="overview-tab-content">
                                        ...
                                        @if($doctor->serial_day > 0 && $doctor->serial_or_slot != null)
                                            <form action="{{ route('appointment.store',$doctor->id) }}"
                                                  class="appointment-from" method="post">
                                                @csrf
                                                    ...
                                                    <div class="row justify-content-center ml-b-30">
                                                        <div class="col-lg-6 mrb-30">
                                                            <div class="booking-appoint-form-area">
                                                                <h4 class="title">@lang('What you wish to discuss in the session')</h4>
                                                                <form class="booking-appoint-form">
                                                                    <div class="row">
                                                                        <div class="col-lg-12 form-group">
                                                                            <textarea name="disease"
                                                                                      placeholder="@lang('Cover Letter')*"></textarea>
                                                                        </div>
                                                                        <div
                                                        ...
                                                        <div class="col-lg-6 mrb-30">
                                                            <div class="booking-confirm-area">
                                                                ...
                                                                <ul class="booking-confirm-list">
                                                                    <li><span>@lang('Date & Time')</span> : <span
                                                                            class="custom-color" id="date"></span> ,
                                                                        <span class="custom-color"
                                                                              id="book-time"></span></li>
                                                                    <li><span>@lang('Fees')</span>
                                                                        : {{ $doctor->fees }} {{ $general->cur_sym }}
                                                                    </li>
                                                                </ul>
                                                                <div class="booking-confirm-btn">
                                                                    <a href="javascript:void(0)"
                                                                       class="cmn-btn-active reset">@lang('Reset')</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
