                        ...
                        <div class="card-body p-0">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="font-weight-bold list-right">{{$user->username}}</span>
                                </li>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="font-weight-bold list-right">{{$user->mobile}}</span>
                                </li>
...
@push('breadcrumb-plugins')
    <a href="{{route('user.profile')}}" class="btn btn-sm btn--primary box--shadow1 text--small"><i
