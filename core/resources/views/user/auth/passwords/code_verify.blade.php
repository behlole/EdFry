        ...
        <div class="form-wrapper">
            ...
            <form action="{{ route('user.password.verify-code') }}" method="POST" class="cmn-form mt-30">
                ...
                <div class="form-group d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('assistant.password.reset') }}" class="text-muted text--small">@lang('Try to send
                        again')</a>
                </div>
...
@push('script-lib')
<script src="{{ asset('assets/assistant/js/jquery.inputLettering.js')}}"></script>
@endpush
@push('style')
    <style>
