...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{asset('assets/assistant/images/1.jpg')}}">
        <div class="form-wrapper">
            ...
            <form action="{{ route('user.password.change') }}" method="POST" class="cmn-form mt-30">
                @csrf
                ...
                <div class="form-group d-flex justify-content-between align-items-center">
                    <a href="{{ route('login') }}" class="text-muted text--small"><i class="las la-lock"></i>@lang('Login Here')</a>
                </div>
